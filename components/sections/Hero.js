  ...
  return (
    <section className="pt-60 flex justify-center lg:justify-start relative 2xl:container px-24 mx-auto">
      <div className="flex flex-col gap-16">
        ...
        <p className="lg:pl-24 text-base max-w-[55rem] font-light text-greyLight leading-base">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Arcu augue massa, tincidunt proin nunc viverra tristique tempor, ipsum. At lectus vel pretium tempor ut dui vivamus sit.</p>
